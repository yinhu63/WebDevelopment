...
function checkProblem(){
 let responce = parseInt(doucument.getElementById("responce").value);
 let output = doucument.getElementById("output");


 let build
Hint: Generate randomnumber to decide whether the problem is an addition, substraction, multiplication or division problem.
*/
